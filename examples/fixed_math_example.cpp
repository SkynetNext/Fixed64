...
int main() {
    ...
    Fixed64_32 angleInRadians =
        Fixed64_32::Deg2Rad() * Fixed64_32(45);  // Convert 45 degrees to radians
    ...
    std::cout << "Interpolated angle from 0 to 90 degrees at t=0.5: " << lerpAngle << std::endl;
