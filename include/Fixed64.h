...
template <typename T> struct Fixed64CastTraits;

namespace detail {
using namespace math::fixed64_traits; // Import type traits
 ...
 *
 */
template <int P> class Fixed64 {
public:
  using value_type = int64_t;

  static constexpr int64_t kRawOne = int64_t(1)
                                     << P; // Scaling factor, maps 1 to 2^P
  ...
  explicit constexpr Fixed64(int64_t raw_value, detail::nothing) noexcept
      : value_(raw_value) {}
  ...
  explicit constexpr Fixed64(IntType i) noexcept
      : value_(static_cast<int64_t>(i) << P) {}
  ...
  explicit constexpr Fixed64(const T &v) noexcept
      : value_(Fixed64CastTraits<std::remove_cvref_t<T>>::template ToFixed64<P>(
            v)) {}
  ...
  explicit constexpr operator T() const noexcept {
    return Fixed64CastTraits<std::remove_cvref_t<T>>::template FromFixed64<P>(
        value_);
  }
  ...
  // Unary operators
  constexpr auto operator+() const noexcept -> Fixed64<P> { return *this; }
  ...
  // Integer constants
  static constexpr auto Zero() noexcept -> Fixed64<P> { return Fixed64<P>(0); }

  static constexpr auto One() noexcept -> Fixed64<P> { return Fixed64<P>(1); }

  static constexpr auto Two() noexcept -> Fixed64<P> { return Fixed64<P>(2); }
  ...
  static constexpr auto Point1() noexcept -> Fixed64<P> { return One() / 10; }

  static constexpr auto Quarter() noexcept -> Fixed64<P> { return One() / 4; }

  static constexpr auto Half() noexcept -> Fixed64<P> { return One() / 2; }
  ...
  static constexpr auto Pi() noexcept -> Fixed64<P> {
    // Pi value (π * 2^63)
    constexpr int128_t PI_BITS = (static_cast<int128_t>(0x1921FB544ULL) << 32) |
                                 static_cast<uint64_t>(0x42D1846AULL);
    constexpr int shift = 63 - P;
    constexpr int128_t rounding =
        (shift > 0) ? (int128_t(1) << (shift - 1)) : 0;
    return Fixed64<P>(static_cast<int64_t>((PI_BITS + rounding) >> shift),
                      detail::nothing{});
  }
  ...
  static constexpr auto TwoPi() noexcept -> Fixed64<P> {
    ...
    constexpr int128_t TWO_PI_BITS =
        (static_cast<int128_t>(0x3243F6A88ULL) << 32) |
        static_cast<uint64_t>(0x85A308D3ULL);
    constexpr int shift = 63 - P;
    constexpr int128_t rounding =
        (shift > 0) ? (int128_t(1) << (shift - 1)) : 0;
  ...
  static constexpr auto HalfPi() noexcept -> Fixed64<P> {
    ...
    constexpr int128_t HALF_PI_BITS =
        (static_cast<int128_t>(0xC90FDAA2ULL) << 32) |
        static_cast<uint64_t>(0x2168C235ULL);
    constexpr int shift = 63 - P;
    constexpr int128_t rounding =
        (shift > 0) ? (int128_t(1) << (shift - 1)) : 0;
  ...
  static constexpr auto QuarterPi() noexcept -> Fixed64<P> {
    ...
    constexpr int128_t QUARTER_PI_BITS =
        (static_cast<int128_t>(0x6487ED51ULL) << 32) |
        static_cast<uint64_t>(0x10B4611AULL);
    constexpr int shift = 63 - P;
    constexpr int128_t rounding =
        (shift > 0) ? (int128_t(1) << (shift - 1)) : 0;
    return Fixed64<P>(
        static_cast<int64_t>((QUARTER_PI_BITS + rounding) >> shift),
        detail::nothing{});
  }
  ...
  static constexpr auto InvPi() noexcept -> Fixed64<P> {
    ...
    constexpr int128_t INV_PI_BITS =
        (static_cast<int128_t>(0x28BE60DBULL) << 32) |
        static_cast<uint64_t>(0x9391054AULL);
    constexpr int shift = 63 - P;
    constexpr int128_t rounding =
        (shift > 0) ? (int128_t(1) << (shift - 1)) : 0;
  ...
  static constexpr auto E() noexcept -> Fixed64<P> {
    // e value (e * 2^63)
    constexpr int128_t E_BITS = (static_cast<int128_t>(0x15BF0A8B1ULL) << 32) |
                                static_cast<uint64_t>(0x45769535ULL);
    constexpr int shift = 63 - P;
    constexpr int128_t rounding =
        (shift > 0) ? (int128_t(1) << (shift - 1)) : 0;
    return Fixed64<P>(static_cast<int64_t>((E_BITS + rounding) >> shift),
                      detail::nothing{});
  }

  static constexpr auto Ln2() noexcept -> Fixed64<P> {
    // ln(2) value (ln(2) * 2^63)
    constexpr int128_t LN2_BITS = (static_cast<int128_t>(0x58B90BFBULL) << 32) |
                                  static_cast<uint64_t>(0xE8E7BCD6ULL);
    constexpr int shift = 63 - P;
    constexpr int128_t rounding =
        (shift > 0) ? (int128_t(1) << (shift - 1)) : 0;
    return Fixed64<P>(static_cast<int64_t>((LN2_BITS + rounding) >> shift),
                      detail::nothing{});
  }
  ...
  static constexpr auto Log2E() noexcept -> Fixed64<P> {
    ...
    constexpr int128_t LOG2E_BITS =
        (static_cast<int128_t>(0xB8AA3B29ULL) << 32) |
        static_cast<uint64_t>(0x5C17F0BCULL);
    constexpr int shift = 63 - P;
    constexpr int128_t rounding =
        (shift > 0) ? (int128_t(1) << (shift - 1)) : 0;
  ...
  static constexpr auto Log10Of2() noexcept -> Fixed64<P> {
    ...
    constexpr int128_t LOG10_OF_2_BITS =
        (static_cast<int128_t>(0x268826A1ULL) << 32) |
        static_cast<uint64_t>(0x3EF3FDE6ULL);
    constexpr int shift = 63 - P;
    constexpr int128_t rounding =
        (shift > 0) ? (int128_t(1) << (shift - 1)) : 0;
    return Fixed64<P>(
        static_cast<int64_t>((LOG10_OF_2_BITS + rounding) >> shift),
        detail::nothing{});
  }
  ...
  static constexpr auto Deg2Rad() noexcept -> Fixed64<P> {
    ...
    constexpr int128_t DEG_TO_RAD_BITS =
        (static_cast<int128_t>(0x23BE8D4ULL) << 32) |
        static_cast<uint64_t>(0x4A53A723ULL);
    constexpr int shift = 63 - P;
    constexpr int128_t rounding =
        (shift > 0) ? (int128_t(1) << (shift - 1)) : 0;
    return Fixed64<P>(
        static_cast<int64_t>((DEG_TO_RAD_BITS + rounding) >> shift),
        detail::nothing{});
  }
  ...
  static constexpr auto Rad2Deg() noexcept -> Fixed64<P> {
    ...
    constexpr int128_t RAD_TO_DEG_BITS =
        (static_cast<int128_t>(0x1CA5DC1A63ULL) << 32) |
        static_cast<uint64_t>(0xC1F7B861ULL);
    constexpr int shift = 63 - P;
    constexpr int128_t rounding =
        (shift > 0) ? (int128_t(1) << (shift - 1)) : 0;
    return Fixed64<P>(
        static_cast<int64_t>((RAD_TO_DEG_BITS + rounding) >> shift),
        detail::nothing{});
  }
  ...
  static constexpr auto NaN() noexcept -> Fixed64<P> { return Min(); }

  static constexpr auto Infinity() noexcept -> Fixed64<P> { return Max(); }
    ...
    if (P > 0) {
      *ptr++ = '.';
      ...
      constexpr int DECIMAL_PLACES =
          static_cast<int>(static_cast<int64_t>(P) * Log10Of2().value() >> P) +
          2;
      ...
      int decimalLength =
          sprintf(decimalBuffer, "%0*lld", DECIMAL_PLACES, scaled);
   ...
   */
  [[nodiscard]] static auto FromString(const std::string &str) noexcept
      -> Fixed64<P> {
    // Handle empty string
    if (str.empty()) {
      return Fixed64<P>();
    ...
    constexpr int32_t MIN_SAFE_DECIMAL_EXPONENT =
        -static_cast<int32_t>((static_cast<int64_t>(P) * Log10Of2().value()) >>
                              P) -
        1;
...
private:
  ...
  friend constexpr auto operator+=(Fixed64<Q> &, const Fixed64<R> &) noexcept
      -> Fixed64<Q> &;
  ...
  template <int Q, typename IntType>
    requires std::is_integral_v<IntType>
  friend constexpr auto operator*=(Fixed64<Q> &, const IntType &) noexcept
      -> Fixed64<Q> &;
  ...
  template <int Q, typename IntType>
    requires std::is_integral_v<IntType>
  friend constexpr auto operator/=(Fixed64<Q> &a, const IntType &b) noexcept
      -> Fixed64<Q> &;
  ...
  template <int Q> friend class Fixed64;
};
...
template <int P, typename T>
  requires(std::is_arithmetic_v<T> ||
           std::is_same_v<T, math::softfloat::soft_double>)
constexpr auto operator<=>(const Fixed64<P> &a, T b) noexcept
    -> std::strong_ordering {
...
template <typename T, int P>
  requires(std::is_arithmetic_v<T> ||
           std::is_same_v<T, math::softfloat::soft_double>)
constexpr auto operator<=>(T a, const Fixed64<P> &b) noexcept
    -> std::strong_ordering {
...
template <int P, int Q>
constexpr auto operator+=(Fixed64<P> &a, const Fixed64<Q> &b) noexcept
    -> Fixed64<P> & {
  if constexpr (P == Q) {
    a.value_ += b.value_;
  } else if constexpr (P > Q) {
...
template <typename T, int P>
  requires std::is_arithmetic_v<T>
constexpr auto operator+(const T &a, const Fixed64<P> &b) noexcept
    -> Fixed64<P> {
  return Fixed64<P>(a) + b;
}
...
template <int P, typename IntType>
  requires std::is_integral_v<IntType>
constexpr auto operator*=(Fixed64<P> &a, const IntType &b) noexcept
    -> Fixed64<P> & {
  a.value_ *= b;
  return a;
}
...
template <int P, typename FloatType>
  requires std::is_floating_point_v<FloatType>
constexpr auto operator*=(Fixed64<P> &a, const FloatType &b) noexcept
    -> Fixed64<P> & {
  a *= Fixed64<P>(b);
  return a;
}
...
template <typename IntType, int P>
  requires std::is_integral_v<IntType>
constexpr auto operator*(const IntType &a, const Fixed64<P> &b) noexcept
    -> Fixed64<P> {
...
template <typename FloatType, int P>
  requires std::is_floating_point_v<FloatType>
constexpr auto operator*(const FloatType &a, const Fixed64<P> &b) noexcept
    -> Fixed64<P> {
  return Fixed64<P>(a) * b;
}
...
namespace std {
// 1. Numeric limits
template <int P> struct numeric_limits<Fixed64<P>> {
...
// 2. Hash support
template <int P> struct hash<Fixed64<P>> {
...
template <int P> inline auto isnan(const Fixed64<P> &x) noexcept -> bool {
  return x == Fixed64<P>::NaN();
}

template <int P> inline auto isinf(const Fixed64<P> &x) noexcept -> bool {
  return x == Fixed64<P>::Infinity() || x == Fixed64<P>::NegInfinity();
}

template <int P> inline auto isfinite(const Fixed64<P> &x) noexcept -> bool {
  return !isnan(x) && !isinf(x);
}

template <int P> inline auto signbit(const Fixed64<P> &x) noexcept -> bool {
  return x.value() < 0;
}

template <int P>
inline auto copysign(const Fixed64<P> &mag, const Fixed64<P> &sgn) noexcept
    -> Fixed64<P> {
...
template <int P>
inline auto fmod(const Fixed64<P> &x, const Fixed64<P> &y) noexcept
    -> Fixed64<P> {
  return x % y;
}

// 5. String conversion
template <int P> string to_string(const Fixed64<P> &num) {
  return num.ToString();
}

template <int P> Fixed64<P> stof64(const string &str) {
  return Fixed64<P>::FromString(str);
}

// 6. Formatting support (C++20)
#if __cplusplus >= 202002L
template <int P> struct formatter<Fixed64<P>> : formatter<string> {
